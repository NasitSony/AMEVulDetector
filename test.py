...
class Test:
    ...
    def train(self):
       ...
       #train_history = self.model.fit([self.pattern3train], self.y_train,
        ...
        train_h = self.model.fit(self.pattern1train, self.y_train, batch_size = self.batch_size, epochs = self.epochs, class_weight = self.class_weight, validation_split=0.2,verbose=2)
